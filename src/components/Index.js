    ...
    return (
      <Jumbotron>
        ...
        <div className="container paragraph">
          <p>
            Ending pandemic is all about working together. The creators of
            PonyExpress want to help communities engage in social distancing by
            coordinating trips for essential items groceries. This is not a
            delivery service by rather a way for people to connect and
            collaborate.
          </p>
        </div>
